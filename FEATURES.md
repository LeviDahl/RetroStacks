...
Everything that's been built, fixed, or decided, moved out of
[`BACKLOG.md`](BACKLOG.md) so the backlog only carries what's still open. This
is a **historical log** kept verbatim from the backlog as it stood on
2026-09-19 — dated, detailed, and including the bugs found along the way and
why they happened. Phrases like "not done yet" inside an entry describe the
...
- Collection & items
- Data feed & backend
- Multi-user sync (Supabase Phase 1)
- Accessibility — VoiceOver compliance work
- Automated leak testing
- UX tap-friction audit (2026-09-13)
- Catalog browsing at scale
- Real-usage feedback, round 1 (2026-09-17)
- Catalog goes live in Supabase (2026-09-17)
- Code health & error analytics
- Platform & polish
- Real-usage feedback, round 2 (2026-09-17…19) — incl. sidebar-lag investigation
- Platform expansion — 19 platforms (2026-09-18)
- RetroGameCollector import (2026-09-18)
- Sidebar-switch lag — findings and fixes (2026-09-19)
